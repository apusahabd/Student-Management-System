						...
						<table id="example" class="table table-hover table-bordered text-center">
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="edit.php?id=<?php echo $info['ID'];?>" class="badge badge-warning">Edit</a> <a href="delete.php?id=<?php echo $info['ID'];?>" class="badge badge-danger "><span name="delete" onclick="return confirm('Do you really want to delete this data ?');">Delete</span></a> <a href="allstudent.php" data-toggle="modal" data-target="#exampleModal<?php echo $info['ID'];?>" class="badge badge-info">View</a></td>
								</tr>
								<?php
									endwhile;
								?>
